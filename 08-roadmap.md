...
0. **Fundamentos: performance, calidad y mobile** ⬅️ _nuevo, con evidencia_
   ...
   - ✅ *Cubierto por **O1** desde el 2026-08-19* (`05-estrategia-okrs`): precisión verificada, cobertura de respuesta, éxito de ejecución, conversión de apertura y tickets por 100 usuarios activos. **El release es su justificación explícita:** la deuda de calidad pasa de "resolver antes de escalar" a **exponerse a ~300 clientes**, con una base que ya llega con NPS −27,8.
