...
|---|---|---|---|---|---|---|
| **MAIA** | Capa de orquestación y punto de entrada único; deriva a especialistas no elegibles por el usuario | El único de MAIA | **128 companies** (13-ago-26) → 🚨 **~300 desde la semana del 24-ago-26** | PM + Director + C-Level. *(El Colaborador tiene acceso desde el Orquestador, 22-jul-26; excluido de la medición por scope, no por permisos — **desde el release entra completo, con ficha propia**)* | **Live.** Sale de beta cerrada con el release del 24-ago-26 | Baseline: **penetración 11,6%** jul-26 `[HECHO]` — **piso conservador** (2026-08-18). **Desde el release, la serie oficial se mide sobre el panel Enterprise + Midmarket** |
...
> 🚨 **MAIA sale de beta cerrada: se libera a toda la base de COR la semana del 24-ago-2026** _(cargado el 2026-08-19)_. Pasa de **128 a ~300 companies** —~172 nuevas— e **incorpora al rol Colaborador**, hasta ahora habilitado solo para un grupo reducido.
>
> **La decisión se tomó fuera de Producto.** La evidencia que aconsejaba esperar sigue en pie y **pasa de ser argumento a ser riesgo**: 12% de las cuentas habilitadas nunca registró un usuario, las 79 companies que Risk Management habilitó en julio aportaron **cero usuarios netos**, y la base llega con **NPS −27,8** y 95% de menciones negativas sobre performance (`07-discovery`).
>
> **Tres consecuencias que viven en otros archivos:** el denominador de medición pasa al **panel Enterprise + Midmarket** y el Colaborador va a **ficha propia** (`06-kpi-tree`, `03-personas`); los **OKRs de la vertical de AI** se escribieron con este release como justificación explícita (`05-estrategia-okrs`); y la deuda de calidad de Risk Management —cuatro cálculos imposibles, severidad que no discrimina— **queda expuesta a toda la base haya GA o no** (`08-roadmap`).
