...
- [ ] **Cerrar el loop cuantitativo:** entre el análisis de adopción de MAIA, el de Marketplace y el de Risk Management (todos ago-2026), `06-kpi-tree` acumula **~20 pedidos de datos abiertos** (11 de la vertical de AI + 9 de Risk Management, más los de Marketplace listados aparte). **Seis están marcados 🔴**, y los cinco que más desbloquean están agrupados en el **pedido consolidado a Data** del final de `06`.
