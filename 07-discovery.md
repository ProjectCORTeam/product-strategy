...
- [ ] **Research sobre las 8 cuentas dormidas y sobre Crowe Global** (ver 🎯 en Temas abiertos → MAIA). Bloquea el playbook de activación del tema 2 de `08-roadmap`. Procesar con `interview-snapshot`. **Ajustar el guion de Crowe:** separar chat de banner antes de atribuir el 23,6%.
  - ⬆️ **Subió de prioridad el 2026-08-19: las 8 dormidas son ahora el KR4 de O2** (`05-estrategia-okrs`), con meta de 6 de 8 cuentas a ≥20% de penetración y CSM dedicado. **El research dejó de alimentar una iniciativa y pasó a sostener un KR con meta.** Y Crowe sigue siendo el insumo del playbook — que, si sale a tiempo, sirve para las cohortes **posteriores** al release, no para la del 24-ago.
- [ ] ⏰ **Entrevistar a los ~15 Colaboradores que usan MAIA hoy** (🎯 nuevo). **Conviene hacerlo antes o muy poco después del release del 24-ago**, mientras el grupo siga siendo identificable y chico: después entra el rol completo y el "por qué la usan" se pierde entre miles de asientos nuevos sin uso. Procesar con `interview-snapshot`.
