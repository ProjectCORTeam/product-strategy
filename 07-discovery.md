...
- 🎯 **¿Por qué las cuentas grandes probaron MAIA y no volvieron?** Ocho cuentas Enterprise concentran 543 asientos con 18 usuarios activos y una intensidad de 1 a 2,2 interacciones mensuales — el patrón no es "uso bajo" sino **no-retorno tras el primer contacto**. ¿Qué pasó en ese primer uso? ¿Falta de onboarding, expectativa incumplida, ausencia de champion, permisos, desconocimiento de que existe? _(Cuentas: TBWA Multisponsor, Ganem Group, Encender, Garnier Agency, Fahrenheit DDB, MASS DIGITAL, Anagram LATAM, DeNicolas.)_
  > 🔺 **Recalificado el 2026-08-31: dejó de ser un pendiente de discovery suelto y pasó a ser el test del supuesto central del set de OKRs.** El laddering a nivel KR (`05-estrategia-okrs`) afirma que **las fricciones de O1 son el leading del uso intensivo, la percepción de valor y la sustitución del flujo de horas de O2** — es decir, **que la fricción causa el no-retorno**. **Nadie lo midió: está marcado `[HIPÓTESIS]`.** Este research es lo que lo pone a prueba.
  > **Condición de refutación, escrita de antemano:** **si las fricciones bajan sostenidamente y el uso intensivo no se mueve nada, el problema del no-retorno no es de calidad y O1 deja de justificarse por esa vía.** Eso sería **un hallazgo, no un fracaso** — pero obliga a reabrir el "¿por qué O1 y no features?" con otra respuesta.
  > ⚠️ **Y el research perdió su KR asociado el 31-ago:** el KR de *recuperación de dormidas* se retiró y lo reemplazó el de sustitución del flujo de horas. **Las ocho cuentas siguen nombrables y siguen siendo la mejor relación valor/esfuerzo del repo** — vuelven como candidato a KR en Q1 2027. **Lo que el research sostiene ahora no es una meta: es el supuesto del que cuelga todo O1.**
...
- 🎯 **Las 79 companies habilitadas en julio no movieron el conteo de usuarios. ¿Por qué?** ⬅️ _nuevo y el más urgente (2026-08-19)._ Entre el inicio de junio y el cierre de julio la base de Risk Management pasó de **15 a 111 companies** habilitadas —55 de ellas el mismo día, el 8-jul— y los usuarios únicos quedaron en **232 → 234**. **Es una pregunta de activación, no de retención, y afecta al 66% de la base.** ¿Se enteraron de que lo tenían? ¿Hubo comunicación del alta? ¿Entraron al proyecto y no vieron banner? ¿Lo vieron y no les habló? _(No depende de ningún corte de datos pendiente: es aritmética sobre lo que ya está en `06-kpi-tree`.)_
- 🎯 **La feature engancha en el momento y no genera vuelta. ¿Por qué?** **Continuidad de conversación en 42,6% (agosto)** contra el patrón de contacto único: 59% de los usuarios hizo una sola consulta en tres meses. El usuario que lo toca conversa, y no vuelve. ¿Qué le faltó — que le avise, que resuelva, que le muestre que el riesgo se cerró? _(Recordar: hoy no hay notificación y no hay aviso cuando el riesgo se resuelve — `01-producto`.)_
  > ⚠️ **Recortado el 2026-08-19.** La formulación original se apoyaba en que "**83% de los usuarios aparece en un solo mes**". Ese número **no controla por fecha de alta**: el 66% de la base se habilitó en julio y no podía haber aparecido antes. **Válido solo sobre la cohorte de mayo-26 (15 companies)**, la única con ventana completa. Ver `06-kpi-tree`.
  > _La continuidad de 42,6% tiene el mismo problema de composición: mayo son 15 companies, agosto son 119. No sostener "el producto mejoró" sin replicar sobre panel cerrado._

> _Un target nuevo (2026-08-19), que aparece con los OKRs de la vertical de AI. Es el más barato de montar de toda esta lista._

- 🎯 **¿Qué necesita el rol Colaborador de MAIA?** ⬅️ _nuevo._ Con el **release del 24-ago** el Colaborador entra a la base completa, y el rol **sigue sin propuesta de valor definida**. Hoy hay **~15 usuarios recurrentes sobre 5.605 asientos (0,27%)** — dos órdenes de magnitud por debajo de los roles con caso de uso definido, lo cual **es esperable y todavía no es un problema de adopción**. Por eso su primer paso **no es un KR sino discovery: son 15 personas usando MAIA sin que nadie les haya dicho para qué, y son 15 entrevistas posibles con nombre y apellido.** ¿Para qué la usan? ¿Desde dónde entran —header o desde una tarea—? ¿Qué esperaban? _(Contexto que conviene tener puesto: el Colaborador es el rol que **se desgasta con el uso** — NPS de −15,2 en onboarding a −34,5 en adopción, I-02c.)_ → alimenta la ficha propia de `03-personas` y el pendiente de propuesta de valor de `05`.
...
- [ ] **Research sobre las 8 cuentas dormidas y sobre Crowe Global** (ver 🎯 en Temas abiertos → MAIA). Bloquea el playbook de activación del tema 2 de `08-roadmap`. Procesar con `interview-snapshot`. **Ajustar el guion de Crowe:** separar chat de banner antes de atribuir el 23,6%.
  - ⬆️ **Subió de prioridad el 2026-08-19: las 8 dormidas eran el KR4 de O2**, con meta de 6 de 8 cuentas a ≥20% de penetración y CSM dedicado. 🔄 **Actualizado el 2026-08-31: ese KR se retiró** —lo reemplazó la sustitución del flujo de horas del Colaborador, porque **la ventana del Colaborador es ahora**— **y el research no baja de prioridad, cambia de función: pasa de sostener una meta a ser el test de la hipótesis de laddering de todo el set** (`05-estrategia-okrs`). **Las 8 cuentas vuelven como candidato a KR en Q1 2027.** Y Crowe sigue siendo el insumo del playbook — que, si sale a tiempo, sirve para las cohortes **posteriores** al release, no para la del 24-ago.
- [ ] ⏰🔴 **Entrevistar a los ~15 Colaboradores que usan MAIA hoy** (🎯). 🔺 **Subió de prioridad el 2026-08-31: el rol dejó de ser "sin propuesta de valor" y pasó a tener KR propio** —O2 · KR6, sustitución del flujo de carga de horas, 0% → 25%— **sobre 5.605 asientos.** El discovery **ya no reemplaza a un KR: alimenta uno que existe**, y la pregunta cambia: no es *"¿para qué usarían MAIA?"* sino ***"¿qué haría que cargues tus horas conversando en vez de por el flujo de siempre?"*** ⚠️ **Y la ventana se cerró a medias: el release ya pasó.** **Conviene hacerlo antes o muy poco después del release del 24-ago**, mientras el grupo siga siendo identificable y chico: después entra el rol completo y el "por qué la usan" se pierde entre miles de asientos nuevos sin uso. Procesar con `interview-snapshot`.
